...
public class CargaEscenas : MonoBehaviour {
    ...
    public GameObject goImagenTextoBiologia;
    public GameObject goImagenTextoHistoria;
	...
	{
		indicadorEscena = 1;
        goImagenTextoBiologia.SetActive(false);
    }
    public void Escena2()
    {
        indicadorEscena = 2;
        goImagenTextoHistoria.SetActive(false);
    }
	...
	public void Url()
	{
		...
		Application.OpenURL("http://oaq.epn.edu.ec/Arastro/sistemasolar.jpg");
	}
